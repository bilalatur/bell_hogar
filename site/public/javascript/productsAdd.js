window.addEventListener("load", function(){
    ...
    let formularioCreacion = document.querySelector("form.productAdd");
    ...
    //let botonBorrar = document.querySelector("button#borrarEdicion");



    formularioCreacion.addEventListener("submit", function(evento){
